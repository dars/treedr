...
<html>
	<head>
		...
		<script src="<?=site_url('public/js/ext/ext-base.js')?>"></script>
		<script src="<?=site_url('public/js/ext/ext-all-debug.js')?>"></script>
		<script src="<?=site_url('public/js/ext/ext-lang-zh_TW.js')?>"></script>
		<script>
